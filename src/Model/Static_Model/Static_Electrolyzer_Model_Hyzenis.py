...
class AWE_Electrolyzer():
    ...
    def Empirical_Faraday_efficiency_cal(self, Current_density, Temp_out, Lye_temp):
        ...
        yita_faraday = (Current_density ** 2 / (self.f11 + self.f12 * Temp_work + (Current_density ** 2))) * (self.f21 + self.f22 * Temp_work)
    ...
    def Working_Optimization(self, Current_density, Pressure):
        ...
        return temp_out_target, lye_flow_target, lye_temp_target, power_consumption_best
...
if __name__ == '__main__':
    ...
    temp_out_target, lye_flow_target, lye_temp_target, power_consumption_best = AWE_Electrolyzer.Working_Optimization(Current_density=3200,
                                                    Pressure=1.6)
    print(lye_flow_target)
